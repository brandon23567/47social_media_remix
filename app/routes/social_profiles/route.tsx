...
export default function SocialProfilesPage(){
    ...
    const openFbLoginDialog = () => {
        ...
        const permissions = "pages_manage_engagement,pages_manage_metadata,pages_manage_posts,pages_messaging,pages_read_engagement,pages_read_user_content,pages_show_list,publish_video,read_insights,instagram_basic,pages_manage_read_engagement";
